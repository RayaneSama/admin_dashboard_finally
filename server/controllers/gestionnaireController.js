...
exports.addPlayer = async (req, res) => {
  ...
  db.query(
    ...
    (err, results) => {
      ...
      res.render("../views/Gestionnaire/add", {
        locals,
        gestId,
        messages2,
        results,
...
exports.postPlayer = async (req, res) => {
  ...
  db.query(
    "SELECT COUNT(*) AS count FROM compte WHERE email_co = ?",
    [email],
    (err, resultmail) => {
      if (err) {
          ...
          (err, result) => {
            ...
            db.query(
              ...
              (err, resultid) => {
                if (err) {
                  console.error(
                    "Erreur lors de l'obtention de l'identifiant du compte: " +
                      err
                  );
                  return res
                    .status(500)
                ...
                db.query(
                  ...
                  (err, resultideq) => {
                    if (err) {
                      console.error(
                        "Erreur lors de l'obtention de l'identifiant de l'équipe: " +
                          err
                      );
                      return res
                        .status(500)
                    ...
                    if (req.file) {
                      ...
                      db.query(
                        "INSERT INTO joueur (nom_jo, prenom_jo, photo_jo, nationalite_jo, poste_jo, num_mai_jo, date_naiss_jo, taille_jo, poids_jo, id_eq_jo, id_co_jo) VALUES (?,?,?,?,?,?,?,?,?,?,?) ",
                        [
                          nom,
                          prenom,
                          photo,
                        ...
                        (err, result) => {
                          if (err) {
                            console.error(
                              "Erreur lors de la création du joueur: " + err
                            );
                            return res
                              .status(500)
                              .send("Erreur lors de la création du joueur");
                          }
                      ...
                      db.query(
                        "INSERT INTO joueur (nom_jo, prenom_jo, nationalite_jo, poste_jo, num_mai_jo, date_naiss_jo, taille_jo, poids_jo, id_eq_jo, id_co_jo) VALUES (?,?,?,?,?,?,?,?,?,?) ",
                        [
                          nom,
                          prenom,
                          nationalite,
                        ...
                        (err, results) => {
                          if (err) {
                            console.error(
                              "Erreur lors de la création du joueur sans photo: " +
                                err
                            );
                            return res
                              .status(500)
...
exports.viewPlayer = async (req, res) => {
  ...
  db.query(
    "SELECT id_jo,nom_jo, prenom_jo,photo_jo, nationalite_jo,nbr_buts_jo,nbr_passe_jo, poste_jo, num_mai_jo, date_naiss_jo, taille_jo, poids_jo,compte.email_co FROM joueur JOIN compte ON joueur.id_co_jo = compte.id_co AND id_jo=?;",
    [userId],
    (err, result) => {
      if (err) {
...
exports.voirEntraineur = async (req, res) => {
  ...
  db.query(
    "SELECT * FROM entraineur INNER JOIN equipe ON equipe.id_eq = entraineur.id_eq_ent INNER JOIN compte ON compte.id_co = entraineur.id_co_ent WHERE id_co_ge_eq=?",
    [userId],
    (err, result) => {
      if (err) {
      ...
      db.query(
        ...
        (err, results) => {
          ...
          res.render("../views/Gestionnaire/detailsEntraineur", {
            locals,
            userId,
            results,
            result,
...
exports.voirStade = async (req, res) => {
  ...
  db.query(
    "SELECT * FROM stade INNER JOIN equipe ON equipe.id_eq = stade.id_eq_std WHERE id_co_ge_eq=?",
    [gestId],
    (err, result) => {
      if (err) {
      ...
      db.query(
        ...
        (err, results) => {
          ...
          res.render("../views/Gestionnaire/detailsStade", {
            locals,
            gestId,
            results,
            result,
...
exports.editPlayer = async (req, res) => {
  ...
  // Exécute une requête SQL pour récupérer les détails du joueur avec l'ID spécifié
  db.query(
    "SELECT id_jo,nom_jo, prenom_jo,photo_jo, nationalite_jo, poste_jo, num_mai_jo, date_naiss_jo, taille_jo, poids_jo,compte.email_co,mot_de_passe FROM joueur JOIN compte ON joueur.id_co_jo = compte.id_co AND id_jo=?;",
    [playerId],
    (err, result) => {
      if (err) {
        console.error("erreur sql id joueur" + err);
...
exports.editEntraineur = async (req, res) => {
  ...
  db.query(
    "SELECT * FROM entraineur JOIN compte ON entraineur.id_co_ent = compte.id_co JOIN equipe ON equipe.id_eq = entraineur.id_eq_ent WHERE id_co_ge_eq = ?;",
    [gestId],
    (err, result) => {
      if (err) {
      ...
      db.query(
        ...
        (err, results) => {
          ...
          res.render("../views/Gestionnaire/modifierEntraineur", {
            locals,
            results,
            result,
            gestId,
...
exports.editStade = async (req, res) => {
  ...
  db.query(
    "SELECT * FROM stade JOIN equipe ON stade.id_eq_std = equipe.id_eq  WHERE id_co_ge_eq = ?;",
    [gestId],
    (err, result) => {
      if (err) {
      ...
      db.query(
        ...
        (err, results) => {
          ...
          res.render("../views/Gestionnaire/modifierStade", {
            locals,
            results,
            result,
            gestId,
      ...
      db.query(
        ...
        (err, resultid) => {
          ...
          if (req.file) {
            ...
            db.query(
              "UPDATE joueur SET nom_jo=?, prenom_jo=?, nationalite_jo=?, poste_jo=?, num_mai_jo=?, date_naiss_jo=?, taille_jo=?, poids_jo=?,id_co_jo=? WHERE id_jo=?",
              [
                newjoueur.nom,
                newjoueur.prenom,
                newjoueur.nationalite,
...
exports.editpostEntraineur = async (req, res) => {
  ...
  try {
    ...
    db.query(
      "UPDATE compte JOIN entraineur ON compte.id_co = entraineur.id_co_ent JOIN equipe ON equipe.id_eq =entraineur.id_eq_ent SET compte.id_type=?, compte.nom_utilisateur=?, compte.mot_de_passe=?, compte.email_co=? WHERE id_co_ge_eq=?",
      [
        2,
        newentraineur.nom + " " + newentraineur.prenom,
        newentraineur.motdepasse,
        newentraineur.email,
        userId,
      ],
      (err, result) => {
        ...
        db.query(
          ...
          (err, resultid) => {
            ...
            if (req.file) {
              ...
              db.query(
                "UPDATE entraineur JOIN equipe ON equipe.id_eq = entraineur.id_eq_ent SET nom_ent = ?, prenom_ent = ?, img_ent=?,nationalite_ent = ?,date_naiss_ent = ? WHERE id_co_ge_eq = ?",
                [
                  newentraineur.nom,
                  newentraineur.prenom,
                  photo,
                  newentraineur.nationalite,
                  newentraineur.date,
                  userId,
                ],
                (err, result) => {
                  if (err) {
                    ...
                    return res
                      .status(500)
                      .send("erreur sql modifier entraineur");
                  }
              ...
              // No file uploaded
              db.query(
                "UPDATE entraineur JOIN equipe ON equipe.id_eq = entraineur.id_eq_ent SET nom_ent = ?, prenom_ent = ?, nationalite_ent = ?, date_naiss_ent = ? WHERE id_co_ge_eq = ?",
                [
                  newentraineur.nom,
                  newentraineur.prenom,
                  newentraineur.nationalite,
...
exports.editpostStade = async (req, res) => {
  ...
  db.query(
    "UPDATE stade  JOIN equipe AS eq1 ON stade.id_eq_std = eq1.id_eq  JOIN equipe AS eq2 ON eq1.id_eq = eq2.id_eq SET stade.nom_std = ?,  stade.ville_std = ?, stade.adresse_std = ?, stade.capacite_std = ?,stade.date_crt=? WHERE eq2.id_co_ge_eq = ? ",
    [
      newstade.nom,
      newstade.ville,
      newstade.adresse,
...
exports.gererJoueur = async (req, res) => {
  ...
  db.query(
    "SELECT joueur.id_jo, joueur.nom_jo, joueur.prenom_jo,photo_jo, joueur.nationalite_jo, joueur.poste_jo, joueur.num_mai_jo, joueur.date_naiss_jo, joueur.taille_jo, joueur.poids_jo, compte.email_co FROM joueur JOIN equipe ON joueur.id_eq_jo = equipe.id_eq JOIN compte ON joueur.id_co_jo = compte.id_co WHERE equipe.id_co_ge_eq = ?; ",
    [gestId],
    (err, result) => {
      if (err) {
...
exports.search = async (req, res) => {
  ...
  db.query(
    "SELECT joueur.id_jo, joueur.nom_jo, joueur.prenom_jo,joueur.photo_jo FROM joueur JOIN equipe ON joueur.id_eq_jo = equipe.id_eq JOIN compte ON joueur.id_co_jo = compte.id_co WHERE (joueur.nom_jo LIKE ? OR joueur.prenom_jo LIKE ?) AND equipe.id_co_ge_eq = ?",
    [`%${recherche}%`, `%${recherche}%`, gestId],
    (err, result) => {
      if (err) {
      ...
      db.query(
        ...
        (err, results) => {
          ...
          res.render("../views/Gestionnaire/recherche", {
            result,
            gestId,
            results,
          });
...
exports.monequipe = async (req, res) => {
  ...
  db.query(
    "SELECT * FROM equipe WHERE id_co_ge_eq=? ",
    [gestId],
    (err, result) => {
      if (err) {
      ...
      db.query(
        "SELECT * FROM entraineur JOIN equipe ON equipe.id_eq = entraineur.id_eq_ent WHERE equipe.id_co_ge_eq = ?",
        [gestId],
        (err, resu) => {
          if (err) {
          ...
          db.query(
            "SELECT * FROM stade  JOIN equipe ON equipe.id_eq = stade.id_eq_std WHERE equipe.id_co_ge_eq = ? ",
            [gestId],
            (err, resultstd) => {
              if (err) {
              ...
              db.query(
                "SELECT * FROM compte WHERE id_co=? ",
                [gestId],
                (err, results) => {
                  if (err) {
                  ...
                  // console.log(results)
                  // console.log(result)
                  res.render("../views/Gestionnaire/equipe", {
                    locals,
                    results,
                    resu,
                    message_ent,
...
exports.addEntraineur = async (req, res) => {
  ...
  db.query(
    ...
    (err, results) => {
      ...
      res.render("../views/Gestionnaire/add_entraineur", {
        locals,
        message_email,
        results,
      });
          ...
          (err, result) => {
            ...
            db.query(
              ...
              (err, resultideq) => {
                if (err) {
                  console.error(
                    "Erreur sql lors de l'obtention de l'identifiant du equipe: " +
                      err
                  );
                  return res
                    .status(500)
                    .send(
                      "Erreur sql lors de l'obtention de l'identifiant de lequipe"
                    );
                }
                db.query(
                  "SELECT id_co FROM compte  WHERE email_co = ?",
                  ...
                  (err, resultidco) => {
                    if (err) {
                      console.error(
                        "Erreur sql lors de l'obtention de l'identifiant du compte: " +
                          err
                      );
                      return res
                        .status(500)
                    ...
                    if (req.file) {
                      photo = req.file.filename;
                      db.query(
                        " INSERT INTO entraineur ( nom_ent, prenom_ent, date_naiss_ent ,img_ent, nationalite_ent, id_eq_ent, id_co_ent) VALUES ( ?,?,?, ?,?, ?, ?);",
                        [
                          newentraineur.nom,
                          newentraineur.prenom,
                          newentraineur.date,
                        ...
                        (err, result) => {
                          if (err) {
                            console.error(
                              "Erreur lors de la création du entraineur: " + err
                            );
                            return res
                              .status(500)
                              .send("Erreur lors de la création du entraineur");
                          }
                      ...
                      db.query(
                        " INSERT INTO entraineur ( nom_ent, prenom_ent, date_naiss_ent , nationalite_ent, id_eq_ent, id_co_ent) VALUES ( ?,?, ?,?, ?, ?);",
                        [
                          newentraineur.nom,
                          newentraineur.prenom,
                          newentraineur.date,
                        ...
                        (err, result) => {
                          if (err) {
                            console.error(
                              "Erreur lors de la création du entraineur sans photo: " +
                                err
                            );
                            return res
                              .status(500)
...
exports.postStade = async (req, res) => {
  ...
  db.query(
    " SELECT id_eq FROM equipe WHERE equipe.id_co_ge_eq = ?",
    [userId],
    (err, result) => {
      if (err) {
      ...
      // console.log(res)
      db.query(
        "INSERT INTO STADE (nom_std,ville_std,adresse_std,capacite_std,date_crt,id_eq_std) VALUES (?,?,?,?,?,?) ",
        [
          newstade.nom,
          newstade.ville,
          newstade.adresse,
...
exports.gerermatch = async (req, res) => {
  ...
  db.query("SELECT * FROM compte  WHERE id_co=? ", [gestId], (err, results) => {
    ...
    db.query(
      "SELECT id_ma FROM `match` WHERE id_co_ge_ma=?",
      [gestId],
      (err, result) => {
        if (err) {
        ...
        // console.log(result)
        if (result.length === 0) {
          res.render("../views/Gestionnaire/pas_daffectation", { results });
        } else {
...
exports.match = async (req, res) => {
  try {
    ...
    const results = await dbQuery("SELECT * FROM compte WHERE id_co=?", [
      gestId,
    ]);
    const result = await dbQuery("SELECT * FROM `match` WHERE id_co_ge_ma=?", [
      gestId,
    ]);
    const reseq = await dbQuery("SELECT * FROM equipe WHERE nom_eq IN (?,?)", [
      result[0].equipe_1,
      result[0].equipe_2,
    ]);

    const resjoeq1 = await dbQuery("SELECT * FROM joueur WHERE id_eq_jo =?", [
      reseq[1].id_eq,
    ]);
    const resjoeq2 = await dbQuery("SELECT * FROM joueur WHERE id_eq_jo =?", [
      reseq[0].id_eq,
    ]);
    ...
    res.render("../views/Gestionnaire/gerermatch", {
      locals,
      gestId,
      results,
      result,
      ...
      resjoeq2,
      matchId,
      message_carton_rouge,
      message_carton_jaune,
      message_but,
    });
  } catch (error) {
...
exports.but = async (req, res) => {
  ...
  try {
    const score = await dbQuery(
      "UPDATE `match` SET score_eq1 = CASE WHEN equipe_1 = ? THEN score_eq1 + 1 ELSE score_eq1 END,  score_eq2 = CASE WHEN equipe_2 = ? THEN score_eq2 + 1 ELSE score_eq2 END  WHERE equipe_1 = ? OR equipe_2 = ?",
      [req.body.equipe, req.body.equipe, req.body.equipe, req.body.equipe]
    );
    const idequipe = await dbQuery("SELECT id_eq FROM equipe WHERE nom_eq=?", [
      req.body.equipe,
    ]);
    var maillotbuteur = parseInt(req.body.joueur[0].split(".")[0].trim());
    var maillotpasseur = parseInt(req.body.joueur[1].split(".")[0].trim());

    const buteur = await dbQuery(
      "UPDATE `joueur` SET nbr_buts_jo = nbr_buts_jo + 1 WHERE num_mai_jo=? AND id_eq_jo=?",
      [maillotbuteur, idequipe[0].id_eq]
    );
    if (maillotpasseur) {
      const passeur = await dbQuery(
        "UPDATE `joueur` SET nbr_passe_jo = nbr_passe_jo + 1 WHERE num_mai_jo=? AND id_eq_jo=?",
        [maillotpasseur, idequipe[0].id_eq]
      );
    }
...
exports.rouge = async (req, res) => {
  ...
  try {
    const rouge = dbQuery(
      "UPDATE `match` SET carton_r_ma = carton_r_ma + 1 WHERE id_ma = ?",
      [matchId]
    );
    const idequipe = await dbQuery("SELECT id_eq FROM equipe WHERE nom_eq=?", [
      req.body.equiperouge,
    ]);
    var maillot_joueur_rouge = parseInt(
      req.body.joueurrouge.split(".")[0].trim()
    );
    console.log(maillot_joueur_rouge);
    const joueur_rouge = dbQuery(
      "UPDATE joueur SET nbr_crt_rouge = nbr_crt_rouge + 1 WHERE num_mai_jo=? AND id_eq_jo=? ",
      [maillot_joueur_rouge, idequipe[0].id_eq]
    );
...
exports.jaune = async (req, res) => {
  ...
  try {
    const jaune = dbQuery(
      "UPDATE `match` SET carton_j_ma = carton_j_ma + 1 WHERE id_ma = ?",
      [matchId]
    );
    const idequipe = await dbQuery("SELECT id_eq FROM equipe WHERE nom_eq=?", [
      req.body.equipejaune,
    ]);
    var maillot_joueur_jaune = parseInt(
      req.body.joueurjaune.split(".")[0].trim()
    );
    console.log(maillot_joueur_jaune);
    const joueur_jaune = dbQuery(
      "UPDATE joueur SET nbr_crt_jaune = nbr_crt_jaune + 1 WHERE num_mai_jo=? AND id_eq_jo=? ",
      [maillot_joueur_jaune, idequipe[0].id_eq]
    );
...
exports.voirAffectation = async (req, res) => {
  ...
  db.query("SELECT * FROM compte WHERE id_co=?", [gestId], (err, results) => {
    ...
    db.query(
      "SELECT * FROM `match` WHERE id_co_ge_ma=? AND date_ma > ?",
      [gestId, formattedDate],
      (err, result) => {
        if (err) {
          console.log(
            "erreur avoir les donnes du match page affectaiotn" + err
          );
        }
        res.render("../views/Gestionnaire/affectation", {
          locals,
          gestId,
          results,
          result,
